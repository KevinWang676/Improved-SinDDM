...
## What's new
We adopt DDPM-IP by introducing a parameter `new_noise`. The only change we make is in [model.py](https://github.com/KevinWang676/SinDDM/blob/f71b8835ce73d295df5b167ad008a3f0f81694e9/SinDDM/models.py#LL591C73-L591C73):
```
